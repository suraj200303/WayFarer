        ...
        <section className='flex-1 overflow-y-auto p-4'>
            {messages.map((msg:Message, index) => (
                ...
                <div className='flex justify-end mt-2' key={index}>
                    <div className='max-w-lg bg-primary text-white px-4 py-2 rounded-lg capitalize'>
                        {msg.content}
                    </div>
                </div> :
        ...
        <section>
            <div className='border rounded-2xl p-4 relative'>
                <Textarea placeholder='Start your trip planing journey...' 
                    className='w-full h-28 bg-transparent border-none focus-visible:ring-0 shadow-none resize-none capitalize'
